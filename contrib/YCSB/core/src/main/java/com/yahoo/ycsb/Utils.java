  ...
  public static Random random() {
    ...
    return ret;
	 ...
	 return Math.abs(hashval);
      ...
      {
          // after a bunch of experimenting, it appears that Java's hashcode provides fewer
          // collisions for the zipfian distribution; LWSR/LWNR have less variance around 1000 items
          // so we're switching it. --p d b
          return Long.toString(val).hashCode();
          /*
	 //from http://en.wikipedia.org/wiki/Fowler_Noll_Vo_hash
